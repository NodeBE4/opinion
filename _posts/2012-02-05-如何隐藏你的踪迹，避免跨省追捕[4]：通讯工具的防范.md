...
date: 2012-02-05T22:52:00+08:00
author: 编程随想的博客
from: https://program-think.blogspot.com/2012/02/howto-cover-your-tracks-4.html
tags: [ 编程随想的博客 ]
categories: [ 编程随想的博客 ]
---

<div class="post hentry uncustomized-post-template">
 <a name="1518181271323738345">
 </a>
 ...
 <div class="post-body entry-content">
  ...
  被党国关了将近一年之后，终于开庭审理。起诉的罪名是：煽动颠覆国家政权；证据是：他在 Skype 聊天记录中的一首诗——《是时候了》。看到此新闻之后，很多网友纷纷担心 Skype 的安全性问题。所以，俺今天重点来聊一聊通讯工具的防范。
  <br/>
  <a name="more">
  </a>
  <!--program-think-->
  ...
  <br/>
  这几类工具都可以用来群发或转发。一旦你转发或群发的内容，包含有敏感的言论（哪怕仅仅是抱怨或者影射），党国都可以说你是“
  <b>
   煽动
  </b>
  颠覆国家政权”（这个罪名的亮点在于“煽动”二字）。
  <br/>
  <br/>
  <h3>
   ◇历史记录
  ...
  <br/>
  一提到聊天软件，天朝的网友自然会想到 QQ。而 QQ 恰恰是【最危险】的 IM 工具。因为 QQ 的用户群实在太大，党国早就在疼逊的服务器上部署了监控和过滤的软件（其原理与 SMS 类似）。只要你在 IM 聊天中涉及了太多的敏感内容，就会被盯上。
  <br/>
  其它几款【国产】的 IM（比如：阿里旺旺、网易泡泡......），也都有这类风险，切不可使用。
  <br/>
  那么，该选择哪些【国外的】IM 捏？考虑到 IM 工具的更新换代很快，俺提几个原则：
  <br/>
  <br/>
  <b>
   原则1：【运营方】的选择
  ...
  <br/>
  一般来说，非营利机构（开源社区）比“商业公司”更靠谱。
  <br/>
  如果你因为种种原因，不得不使用商业公司的 IM，选一个口碑更好的商业公司的 IM。
  <br/>
  <br/>
  <b>
   原则2：是否绑定手机号
  ...
  <br/>
  尽量使用那种【无需】绑定手机号的 IM 工具。道理很简单——
  <br/>
  当 IM 工具绑定了手机号，也就意味着——IM 的运营方有可能会收集你的手机号信息。对大部分网民而言，通过“手机号”很容易就可以定位到【自然人身份】。
  <br/>
  如果你因为种种原因，不得不使用某款需要绑定手机号的 IM 工具，你要【确保】——该手机号与你的自然人身份【完全无关】（比如说，你可以购买那种【不记名】的手机卡，并且在购买时用【现金】支付）
  <br/>
  <br/>
  <b>
   原则3：是否支持桌面操作系统
  ...
  <br/>
  2004年出过一个很轰动的师涛案，估计有些网友还记得吧？（不知道此事的网友，请看“
  <a href="https://zh.wikipedia.org/wiki/%E5%B8%88%E6%B6%9B" rel="nofollow" target="_blank">
   这里
  </a>
  ”的介绍）师涛就是因为用了雅虎邮箱而倒霉的。当年国安局的人找雅虎交涉，让雅虎交出师涛邮箱的信息。据说国安局尚未施加压力，这个没骨气的雅虎就乖乖交出来了。师涛因此被判10年监禁。
  <br/>
  所以，光是国外的邮箱还不够，还得找有骨气的外国公司的邮箱。
  <br/>
  俺第 N 次呼吁，
  <b>
   大伙儿尽量用 Google 提供的 Gmail 邮箱
  </b>
  。Google 的骨气，想必大家也都是知道的——敢于跟朝廷唱对台戏。在国外公司里，这么有骨气的公司真不多见。另外，Google 在【信息安全】方面的技术实力也是一流滴，有助于保障 Gmail 的安全性，防止黑客入侵。
  <br/>
  <br/>
  <br/>
  <h2>
  ...
  <br/>
  不使用自动登录的话，每次都要输入口令（假如同时用几个邮箱或 IM，就得输入多次口令），估计大部分人会嫌麻烦。所以加密存储属于即安全又方便的做法。加密存储当然也要输入口令，但是只需输入一次（具体如何搞，后面会说）。
  <br/>
  <br/>
  <h3>
   ◇本地存储的隐患
  ...
  <br/>
  说到本地加密，
  <a href="https://en.wikipedia.org/wiki/TrueCrypt" rel="nofollow" target="_blank">
   TrueCrypt
  </a>
  实在是不二之选。关于它的优点及功能介绍，请看俺专门写的扫盲帖（在“
  <a href="https://program-think.blogspot.com/2011/05/recommend-truecrypt.html">
   这里
  </a>
  ”）。简而言之，TrueCrypt 是目前最靠谱的文件加密工具。据说老美的 FBI，如果碰上嫌犯使用 TrueCrypt 加密数据，也是束手无策。
  <br/>
  补充说明：
  <br/>
  由于
  <a href="https://program-think.blogspot.com/2014/06/truecrypt-dead.html">
   TrueCrypt 在2014年已经停止开发了
  </a>
  ，于是俺又介绍了它的两款替代品，分别是
  ...
  。这两款工具都可以完美兼容“TrueCrypt 的加密分区格式”。
  <br/>
  <br/>
  <h3>
   ◇哪些文件需要加密？
  ...
  <br/>
  前面俺已经建议过，【不要】把邮件同步到本地。如此一来，你只需解决邮箱“自动登录”的问题。几乎所有的 Web 邮箱（网页邮箱），都是依靠“cookie”来实现自动登录的。主流的浏览器（包括IE、Firefox、Chrome），其 cookie 文件的存放位置都位于当前用户的
  <code>
   %APPDATA%
  </code>
  目录之下（在资源管理器的地址栏输入
  ...
  <br/>
  Skype 用来保存自动登录口令及聊天历史的那些文件，也是在
  <code>
   %APPDATA%
  </code>
  目录之下。
  ...
  目录所在的盘就是系统盘（也叫系统分区）。因此，你用 TrueCrypt【对整个系统盘加密】，即可确保安全。
  <br/>
  至于如何用 TrueCrypt 加密系统盘，大伙儿请仔细阅读该软件的使用手册（可惜是洋文滴）。那些看不懂洋文的同学，自己去 Google 一下详细的教程吧。
  <br/>
  TrueCrypt 的加密操作只需执行一次。加密前，TrueCrypt 会让你设置一个口令。这个口令千万别丢了！否则的话，你的系统盘就彻底废了，只能重新格式化。
  <br/>
  加密完系统盘之后，你每次开机，都需要先输入该口令。口令正确，操作系统才能启动起来。如果没有口令，别人即使拿到你的硬盘，也甭想看到加密盘中的
  <b>
   任何文件
  </b>
  。
  ...
  <br/>
  4. 对于加密了系统盘的电脑，当你不用电脑的时候，要【关机】，而不要【待机】
  <br/>
  <br/>
  引申阅读：
  <br/>
  ...
  <div class="post-copyright">
   ...
   和本文原始地址：
   <br/>
   <a href="https://program-think.blogspot.com/2012/02/howto-cover-your-tracks-4.html" id="OriginalPostUrl">
    https://program-think.blogspot.com/2012/02/howto-cover-your-tracks-4.html
   </a>
  </div>
