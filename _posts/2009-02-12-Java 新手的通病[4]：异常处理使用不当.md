...
date: 2009-02-12T18:02:00+08:00
author: 编程随想的博客
from: https://program-think.blogspot.com/2009/02/defect-of-java-beginner-4-exception.html
tags: [ 编程随想的博客 ]
categories: [ 编程随想的博客 ]
---

<div class="post hentry uncustomized-post-template">
 <a name="5256051381573290083">
 </a>
 ...
 <div class="post-body entry-content">
  ...
  <br/>
  2. 对同一个函数的多处调用，都需要对返回值进行重复判断，导致代码冗余（代码冗余的坏处，
  <a href="https://program-think.blogspot.com/2009/02/defect-of-java-beginner-3-code-style.html#copy_and_paste">
   上一个帖子
  </a>
  也已经聊过了）。
  <br/>
  ...
  <br/>
  <br/>
  上面就是几种常见的Java异常处理的误用。下一个帖子我们来聊一下“
  ...
  <div class="post-copyright">
   ...
   和本文原始地址：
   <br/>
   <a href="https://program-think.blogspot.com/2009/02/defect-of-java-beginner-4-exception.html" id="OriginalPostUrl">
