...
date: 2010-08-02T23:38:00+08:00
author: 编程随想的博客
from: https://program-think.blogspot.com/2010/08/howto-prevent-hacker-attack-4.html
tags: [ 编程随想的博客 ]
categories: [ 编程随想的博客 ]
---

<div class="post hentry uncustomized-post-template">
 <a name="1932370385403388144">
 </a>
 ...
 <div class="post-body entry-content">
  ...
  ”）。今天扫盲一下跟安全漏洞相关的知识，为下一篇（Web 相关的防范）做好铺垫。考虑到俺博客的读者群，本文主要拿Windows桌面系统来举例，并且尽量说得浅显一点。
  <br/>
  <a name="more">
  </a>
  <!--program-think-->
  ...
  <br/>
  近几年来，基于 Web 的攻击日益增多，所以把 Web 漏洞单独分一类。所谓的“Web 漏洞”，也就是跟Web相关的漏洞——包括了浏览器本身的漏洞和网站的漏洞（
  ...
  <div class="post-copyright">
   ...
   和本文原始地址：
   <br/>
   <a href="https://program-think.blogspot.com/2010/08/howto-prevent-hacker-attack-4.html" id="OriginalPostUrl">
    https://program-think.blogspot.com/2010/08/howto-prevent-hacker-attack-4.html
   </a>
  </div>
