...
date: 2015-10-04T22:28:00+08:00
author: 编程随想
from: https://program-think.blogspot.com/2015/10/Blog-Enable-HTTPS.html
tags: [ 编程随想 ]
categories: [ 编程随想 ]
---

<div class="post hentry uncustomized-post-template">
 <a name="7832740516169759871">
 </a>
 ...
 <div class="post-body entry-content">
  <center>
   <img alt="不见图 请翻墙" src="https://lh6.googleusercontent.com/2UOkEgaXLx6jfjKYBC_LZ38TA8ferB9CZBFCYY5mXQqxtdb7yxvyt_OPCs-yXu4vNq6F7zUji5BQpzdtC9XmBizQn0Ody2Jwd6VDM_v9SOrilIOcIJZSmreiXNPi_7vCwnoOVN6qdg"/>
  </center>
  <br/>
  <h2>
   ★引子
  ...
  <br/>
  沦陷日长假的第一天，俺打算上博客回复读者评论。通常俺会先登录到 Blogger 的管理界面，清理一下被 Google 误判为垃圾广告的读者评论。结果在管理界面的首页，就看到了 Blogger 的最新消息——
  <a href="https://googleonlinesecurity.blogspot.com/2015/09/https-support-coming-to-blogspot.html" rel="nofollow" target="_blank">
  ...
  <br/>
  经过上述改造之后，所有的站内链接都是 HTTPS 的。因此，
  <b>
   读者在博客中浏览或者发评论时，网络流量【全都是】加密的
  </b>
  。
  <br/>
  <br/>
  ...
  <br/>
  <br/>
  HTTPS 的底层实现依赖于 TLS/SSL。具体的技术细节可以参见俺的另一个系列《
  ...
  <br/>
  大约一年前（2014年8月），Google 调整了搜索引擎的算法，提升了 HTTPS 网址的权重。具体介绍参见 Google 的公告（在“
  <a href="http://googlewebmastercentral.blogspot.com/2014/08/https-as-ranking-signal.html" rel="nofollow" target="_blank">
   这里
  </a>
  ”）。
  <br/>
  ...
  <br/>
  如果你也碰到类似问题，可以参考俺的修改——查看俺博客页面源代码，然后搜索：
  <b>
   Avatar URL force HTTPS
  </b>
  （只要略懂 JS 代码，应该能看明白）
  <br/>
  <br/>
  ...
  <br/>
  这是一个 Web 工具，网址是：
  <a href="https://www.ssllabs.com/ssltest/" rel="nofollow" target="_blank">
  ...
  <br/>
  经某热心读者提醒，顺便再推荐一个浏览器扩展——
  <a href="https://en.wikipedia.org/wiki/HTTPS_Everywhere" rel="nofollow" target="_blank">
   HTTPS Everywhere
  </a>
  <br/>
  ...
  <br/>
  该扩展同时提供
  <a href="https://addons.mozilla.org/en/firefox/addon/https-everywhere/" rel="nofollow" target="_blank">
   Firefox 版本
  </a>
  和
  <a href="https://chrome.google.com/webstore/detail/https-everywhere/gcbommkclmclpchllfjekcdonpmejbdp" rel="nofollow" target="_blank">
   Chrome 版本
  </a>
  。
  <br/>
  补充说明：
  <br/>
  为啥 HTTPS Everywhere 要依靠一个规则集，为啥不对任何网站自动检测是否有 HTTPS？其官网的回复在“
  <a href="https://www.eff.org/https-everywhere/faq#faq-Why-use-a-whitelist-of-sites-that-support-HTTPS?-Why-can%27t-you-try-to-use-HTTPS-for-every-last-site,-and-only-fall-back-to-HTTP-if-it-isn%27t-available?" rel="nofollow" target="_blank">
   这里
  </a>
  ”
  <br/>
  ...
  <div class="post-copyright">
   ...
   和本文原始地址：
   <br/>
   <a href="https://program-think.blogspot.com/2015/10/Blog-Enable-HTTPS.html" id="OriginalPostUrl">
