 ...
 <div class="entry-content">
  ...
  <p>
   ...
   <mfn>
    ...
    ，类似这样的网页备份工具还有
    <a href="https://archive.ph/" rel="noreferrer noopener" target="_blank">
     https://archive.ph
    </a>
    。另外，
    <a href="https://github.com/rahiel/archiveror" rel="noreferrer noopener" target="_blank">
  ...
  <p>
   ...
   ）本身，使开始面向点对点网络。你可以通过 HTTP、WebTorrent、IPFS 和 GUN 数据库来访问
   <a href="http://dweb.archive.org/" rel="noreferrer noopener" target="_blank">
    dweb.archive.org
   </a>
   。
   <mfn>
